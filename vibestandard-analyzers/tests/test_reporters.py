...
def sample_findings():
    return [
        Finding(
            ...
            severity="critical",
            explanation="H2 is a test database and should not be used in production",
            why_it_matters="H2 loses all data on every restart, causing total data loss in production",
        ...
        Finding(
            ...
            severity="medium",
            explanation="Application does not use structured logging",
            why_it_matters="Without structured logs, debugging production issues takes hours instead of minutes",
