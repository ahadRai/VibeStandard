  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit}>
        <div
          className="relative flex flex-col md:flex-row items-stretch md:items-center rounded-xl border transition-all"
          style={{
        ...
        >
          ...
          <button
            ...
            className="mx-2 mb-2 md:m-2 px-6 font-medium flex items-center justify-center gap-2 transition-all duration-200"
            style={{
              height: '48px',
